...
function factorialNumberGetter(formula, FACTORIAL_SEARCH_RESULT1) {
    let numbers = []
    let factorial_sequence = 0

    FACTORIAL_SEARCH_RESULT1.forEach(factorial_index => {
        let number = []
...
function powerBaseGetter(formula, POWER_SEARCH_RESULT1) {
    let powers_bases = [];
    POWER_SEARCH_RESULT1.forEach(power_index => {
        let base = []
